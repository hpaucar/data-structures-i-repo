//============================================================================
// Name        : usaListaLigadaInterativoD.c
...
void buscar(LISTA *l) {
	...
	if (posicao != NULL)
		printf("Elemento %i encontrado no endereco %p.\n", ch, posicao);
	else
		printf("Nao foi possivel encontrar elemento %i.\n", ch);
}
...
void exibirPrimeiro(LISTA *l) {
	...
	if (posicao != NULL)
		printf("Primeiro elemento %i encontrado no endereco %p.\n", ch,
				posicao);
	else
		printf("Nao foi possivel encontrar o primeiro elemento (lista vazia).\n");
}
...
void exibirUltimo(LISTA *l) {
	...
	if (posicao != NULL)
		printf("Ultimo elemento %i encontrado no endereco %p.\n", ch, posicao);
	else
		printf("Nao foi possivel encontrar o ultimo elemento (lista vazia).\n");
}

void excluir(LISTA *l) {
	TIPOCHAVE ch;
	scanf("%i", &ch);
	if (excluirElemLista(l, ch))
