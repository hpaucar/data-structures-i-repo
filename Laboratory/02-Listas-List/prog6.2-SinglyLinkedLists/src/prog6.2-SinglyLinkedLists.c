/*
 ============================================================================
 Name        : 2-SinglyLinkedLists.c
 Author      : Herminio
 Version     :
 Copyright   : Your copyright notice
 Description : Write a program to create a linked list and perform insertions and deletions of all cases.
				Write functions to sort and finally delete the entire list at once.Hello World in C, Ansi-style
 ============================================================================
 */
